insert  into `sys_permission`(`id`,`name`,`type`,`url`,`percode`,`parentid`,`parentids`,`sortstring`,`available`) values (1,'权限','','',NULL,0,'0/','0','1'),(11,'商品管理','menu','items/queryItems',NULL,1,'0/1/','1.','1'),(12,'商品新增','permission','items/add','item:create',11,'0/1/11/','','1'),(13,'商品修改','permission','items/editItems','item:update',11,'0/1/11/','','1'),(14,'商品删除','permission','','item:delete',11,'0/1/11/','','1'),(15,'商品查询','permission','items/queryItems','item:query',11,'0/1/15/',NULL,'1'),(21,'用户管理','menu','user/query','user:query',1,'0/1/','2.','1'),(22,'用户新增','permission','','user:create',21,'0/1/21/','','1'),(23,'用户修改','permission','','user:update',21,'0/1/21/','','1'),(24,'用户删除','permission','','user:delete',21,'0/1/21/','','1');
...
('zhangsan','zhangsan','张三','17be54f75e9ba2be46ff0b04bba025cc','eteokues','0'),
('admin01','admin01','admin','17be54f75e9ba2be46ff0b04bba025cc','eteokues','0');
...
('ebc9d666-c6f9-11e4-b137-0adc305c3f28','admin01','ebc8a441-c6f9-11e4-b137-0adc305c');
...
<head>
    ...
    <STYLE type="text/css">
        .btnalink {
            ...
            line-height: 30px;
            background: url("<c:url value='/images/login/btnbg.jpg'/>") no-repeat;
            font-size: 14px;
            color: #fff;
            font-weight: bold;
...
<BODY style="background: #f6fdff url(<c:url value='/images/login/bg1.jpg'/>) repeat-x;">
<FORM id="loginform" name="loginform" action="<c:url value='/'/>login"
    ...
    <DIV class="logincon">
        ...
        <DIV class="cen_con">
            <IMG alt="" src="<c:url value='/images/login/bg2.png'/>">
        </DIV>
            ...
            <TABLE class="tab" border="0" cellSpacing="6" cellPadding="8">
                ...
                <TR>
                    ...
                    <TD>
                        ...
                        <img id="randomcode_img" src="<c:url value='/validatecode.jsp'/>" alt="" width="56" height="20"
                             align='absMiddle'/>
